...
namespace FinalTrabajo.Controllers
{
    public class HistoricoesController : Controller
    {
        ...
        public HistoricoesController(Context context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Historicos.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,MonedaOrigen,MonedaDestino,Importe,Resultado,Factor,Usuario,Fecha")] Historico historico)
        {
            if (ModelState.IsValid)
            {
                historico.Usuario = User.Identity.Name;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MonedaOrigen,MonedaDestino,Importe,Resultado,Factor,Usuario,Fecha")] Historico historico)
        {
            if (id != historico.Id)
            {
                return NotFound();
