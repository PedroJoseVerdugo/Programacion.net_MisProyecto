...
namespace FinalTrabajo.Controllers
{
    public class PaisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Capital,Bandera,Idioma,Moneda")] Pais pais)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Capital,Bandera,Idioma,Moneda")] Pais pais)
        {
            if (id != pais.Id)
            {
                return NotFound();
