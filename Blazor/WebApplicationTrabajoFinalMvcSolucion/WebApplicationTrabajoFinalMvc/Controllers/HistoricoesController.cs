...
namespace WebApplicationTrabajoFinalMvc.Controllers
{
    public class HistoricoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MonedaOrigen,MonedaDestino,Importe,Resultado,Fecha,Factor,Usuario")] Historico historico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,MonedaOrigen,MonedaDestino,Importe,Resultado,Fecha,Factor,Usuario")] Historico historico)
        {
            if (id != historico.Id)
            {
                return NotFound();
        ...
        private bool HistoricoExists(string id)
        {
