...
namespace WebApplicationTrabajoFinalMvc.Controllers
{
    public class PaisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Capital,Moneda")] Pais pais)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Nombre,Capital,Moneda")] Pais pais)
        {
            if (id != pais.Id)
            {
                return NotFound();
